...
interface ButtonInterface extends BaseButtonInterface {
     ...
     * @var string
     */
    public const BUTTON_SIZE_LG = "lg";
     ...
     * @var string
     */
    public const BUTTON_SIZE_SM = "sm";
     ...
     * @var string
     */
    public const BUTTON_SIZE_XS = "xs";
     ...
     * @var string
     */
    public const BUTTON_TYPE_DARK = WBWBootstrapBundle::BOOTSTRAP_TYPE_DARK;
     ...
     * @var string
     */
    public const BUTTON_TYPE_DEFAULT = WBWBootstrapBundle::BOOTSTRAP_TYPE_DEFAULT;
     ...
     * @var string
     */
    public const BUTTON_TYPE_LIGHT = WBWBootstrapBundle::BOOTSTRAP_TYPE_LIGHT;
     ...
     * @var string
     */
    public const BUTTON_TYPE_PRIMARY = WBWBootstrapBundle::BOOTSTRAP_TYPE_PRIMARY;
     ...
     * @var string
     */
    public const BUTTON_TYPE_SECONDARY = WBWBootstrapBundle::BOOTSTRAP_TYPE_SECONDARY;
