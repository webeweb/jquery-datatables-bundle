...
/**
 * Navigation item "users groups".
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Bundle\BootstrapBundle\Component\Navigation\Glyphicon
 */
class NavigationItemUsersGroups extends NavigationNode {
    ...
    public function __construct(?string $route, string $matcher = self::MATCHER_URL) {
        parent::__construct("navigation.item.users_groups", "g:user", $route, $matcher);
    }
}
