...
class PinkColorTest extends AbstractTestCase {
    ...
    public function testGetValues(): void {
        ...
        $this->assertEquals(PinkColorInterface::PINK_COLOR_VALUE_800, $res[ColorInterface::COLOR_VALUE_800]);
        $this->assertEquals(PinkColorInterface::PINK_COLOR_VALUE_900, $res[ColorInterface::COLOR_VALUE_900]);
    }
