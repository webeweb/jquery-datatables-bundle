...
class CyanColorTest extends AbstractTestCase {
    ...
    public function testGetValues(): void {
        ...
        $this->assertEquals(CyanColorInterface::CYAN_COLOR_VALUE_800, $res[ColorInterface::COLOR_VALUE_800]);
        $this->assertEquals(CyanColorInterface::CYAN_COLOR_VALUE_900, $res[ColorInterface::COLOR_VALUE_900]);
    }
