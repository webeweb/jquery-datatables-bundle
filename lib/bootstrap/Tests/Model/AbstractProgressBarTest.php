...
use WBW\Bundle\BootstrapBundle\Tests\Fixtures\Model\TestProgressBar;
...
class AbstractProgressBarTest extends AbstractTestCase {
    ...
    public function testJsonSerialize(): void {
        ...
        $data = file_get_contents(__DIR__ . "/../Fixtures/Model/AbstractProgressBarTest.testJsonSerialize.json");
