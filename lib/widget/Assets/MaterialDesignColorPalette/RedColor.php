...
class RedColor extends AbstractColor implements RedColorInterface {
    ...
    public function getValues(): array {
        ...
        return [
            self::COLOR_VALUE_50   => self::RED_COLOR_VALUE_50,
            ...
            self::COLOR_VALUE_A100 => self::RED_COLOR_VALUE_A100,
            self::COLOR_VALUE_A200 => self::RED_COLOR_VALUE_A200,
            self::COLOR_VALUE_A400 => self::RED_COLOR_VALUE_A400,
            self::COLOR_VALUE_A700 => self::RED_COLOR_VALUE_A700,
        ];
    }
}
