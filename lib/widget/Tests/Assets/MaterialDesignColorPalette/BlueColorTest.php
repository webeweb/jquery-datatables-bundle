...
class BlueColorTest extends AbstractTestCase {
    ...
    public function testGetValues(): void {
        ...
        $this->assertEquals(BlueColorInterface::BLUE_COLOR_VALUE_50, $res[ColorInterface::COLOR_VALUE_50]);
        ...
        $this->assertEquals(BlueColorInterface::BLUE_COLOR_VALUE_A100, $res[ColorInterface::COLOR_VALUE_A100]);
        $this->assertEquals(BlueColorInterface::BLUE_COLOR_VALUE_A200, $res[ColorInterface::COLOR_VALUE_A200]);
        $this->assertEquals(BlueColorInterface::BLUE_COLOR_VALUE_A400, $res[ColorInterface::COLOR_VALUE_A400]);
        $this->assertEquals(BlueColorInterface::BLUE_COLOR_VALUE_A700, $res[ColorInterface::COLOR_VALUE_A700]);
    }
