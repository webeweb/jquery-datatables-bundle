...
/**
 * Create DataTables controller test.
 *
 * @author webeweb <https://github.com/webeweb>
 * @package WBW\Bundle\DataTablesBundle\Tests\Controller
 */
class CreateDataTablesControllerTest extends AbstractWebTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals("wbw.datatables.controller.create", CreateDataTablesController::SERVICE_NAME);
    }
}
